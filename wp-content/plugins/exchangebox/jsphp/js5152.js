...
jQuery(function($){
	$('.captcha_reload').live('click',function(){
		...
		$.ajax({
		type: "POST",
		url: "https://exxe.club/ajax-sc_reload.html?notcsrf=a0c1c61c7e",
		dataType: 'json',
		data: dataString,
		success: function(ht)
		{
...
jQuery(function($){
	...
	function goed_peremen(summ, dej){
        ...
        $.ajax({
            type: "POST",
            url: "https://exxe.club/ajax-exchange_peremen.html?notcsrf=a0c1c61c7e",
            data: dataString,
	        dataType: 'json',
            success: function(ht){
...
jQuery(function($){
	...
	if(countwidget > 0){ 
		...
		$('a.onehrine').live('click', function(){
            ...
            $.ajax({
            type: "POST",
            url: "https://exxe.club/ajax-widtable.html?notcsrf=a0c1c61c7e",
            data: dataString,
	        dataType: 'json',
            success: function(ht){
		        if(ht['table']){
...
function big_ajax_zapros(ids,idtab,idtab2){
    ...
    $.ajax({
        type: "POST",
        url: "https://exxe.club/ajax-exchange_step1.html?notcsrf=a0c1c61c7e",
        data: dataString,
	    dataType: 'json',
        success: function(ht){
		    if(ht['otv'] == 'success'){
